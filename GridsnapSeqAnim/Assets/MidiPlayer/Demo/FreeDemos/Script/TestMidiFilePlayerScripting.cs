    ...
    public class TestMidiFilePlayerScripting : MonoBehaviour
    {
        ...
        public void StartPlay(string name)
        {
            ...
            if (midiFilePlayer != null)
            {
                ...
                infoMidi += $"Pulse Length : {midiFilePlayer.MPTK_PulseLength} milliseconds (MIDI resolution)\n";
        ...
        void Update()
        {
            if (midiFilePlayer != null && midiFilePlayer.MPTK_IsPlaying && !ControlPanelFuncs.isPaused)
            {
