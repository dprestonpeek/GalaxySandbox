...
namespace MidiPlayerTK
{
    ...
    public partial class MidiFilePlayer : MidiSynth
    {
        ...
        /// </summary>
        public double MPTK_PulseLength { get { try { if (midiLoaded != null) return midiLoaded.MPTK_PulseLenght; } catch (System.Exception ex) { MidiPlayerGlobal.ErrorDetail(ex); } return 0d; } }
